			...
			<div class="item-meta bb-reply-meta">
				...
				<div>
					<span class="bs-replied">
						<span class="bbp-topic-freshness-author"><?php bbp_author_link( array( 'post_id' => bbp_get_reply_id(), 'size' => 1 ) ); ?></span> <?php _e('replied', 'press-pool'); ?> <?php bbp_reply_post_date(); ?>
					</span>
				</div>
			</div>
		</div>
