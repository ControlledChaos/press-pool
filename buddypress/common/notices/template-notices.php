...
<aside class="<?php bp_nouveau_template_message_classes(); ?>">
	...
	<?php if ( bp_nouveau_has_dismiss_button() ) : ?>
		<button type="button" data-balloon-pos="down" class="" data-balloon="<?php echo esc_attr_x( 'Close', 'button', 'press-pool' ); ?>" aria-label="<?php esc_attr_e( 'Close this notice', 'press-pool' ); ?>" data-bp-close="<?php bp_nouveau_dismiss_button_type(); ?>"><span class="bb-icon-close-circle" aria-hidden="true"></span></button>
	<?php endif; ?>
